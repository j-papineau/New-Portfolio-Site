...
const Skills = (props: Props) => {
  return (
    <div className=' flex h-[120vh] relative flex-col text-center md:text-left xl:flex-col max-w-[1000px]
    ...
    <div className='text-xl'>
        <ul className=' text-gray-300 [&>li]:text-slate-300 [&>li]:underline'>
            <li className='tracking-widest'>Machine Learning w/ Python</li>
            ...
            <li className='tracking-widest'>Python App Development</li>
            <ul className='text-sm ml-10'>
                <li>TKinter</li>
                <li>PyQt5 and 6</li>
            </ul>
